...
![custom breed cooldown datapack/mod title image minecraft](https://cdn.jsdelivr.net/gh/jodeks-datapacks/Assets@main/titles/custom_breed_cooldown.png)
...
[![custom breed cooldown minecraft datapack github issues](https://cdn.jsdelivr.net/gh/jodeks-datapacks/Assets@main/badges/GH_Issues.png)](https://github.com/jodeks-datapacks/custom-breed-cooldown/issues)&nbsp;&nbsp;
...
## Config
```
/trigger custom_breed_cooldown.config
```

## Config for 1.21.5 and down

To change the breed cooldown for every mob:

```
/scoreboard players set &mob_cooldown config.custombreedcooldown value
```
...
```
/scoreboard players set &villager_cooldown config.custombreedcooldown value
```
value = breed cooldown in seconds

---

default = vanilla cooldown (5 minutes - 300 seconds)

#### You can't customize the cooldown for any version below 1.21, it will always be set to 0 seconds 
